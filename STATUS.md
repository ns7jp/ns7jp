...
最終更新：2026-07-03（選考導線の整備＝職務経歴書復活・連絡先明記、設計テーマの縮退、証跡採録の優先順位見直し、資格ロードマップの見直し、AI 活用の開示）
...
- [ ] **resume.md / overview の `〈 〉` 箇所を記入**（在籍企業名・在籍年月・現況・夜勤/交代制の可否・雇用形態の希望）
- [ ] **証跡の採録を開始**（[#8](https://github.com/ns7jp/ns7jp/issues/8) で管理。優先 1〜3 の Grafana / Slack / Loki スクショは 1 晩・0 円で可能）
- [ ] **Issue #5〜#8 の週 1 回更新を開始**（LPIC-1 の現在の学習状況・受験予約の有無を最初のコメントで記録）
