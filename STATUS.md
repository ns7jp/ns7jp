...
最終更新：2026-05-29（職務経歴書・採用担当者向けサマリを追加、学習ログ / 実証トラッキング Issue を作成、README の設計テーマ表示を圧縮）
...
| 職務経歴書・スキルシート | ✅ 完了（応募用。`〈 〉` は本人記入のプレースホルダ） |
...
- [ ] **実機の実測証跡を採録**（[#8](https://github.com/ns7jp/ns7jp/issues/8) で管理。設計過多に対し最優先の伸びしろ）
- [ ] 職務経歴書の `〈 〉` プレースホルダ（在籍企業名・期間・学歴年月）を実情報へ置き換え
