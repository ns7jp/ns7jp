...
| 技術面談でどう説明するか | [30秒・3分説明](../../../docs/portfolio-explanation.md) | 実際に問われた問いを次の練習へ戻す |
...
本人の試行から次の学習課題と再説明を選ぶには、[自律型成長システム](../autonomous-growth/README.md)を使います。
明示した学習枠の内訳として扱い、週10時間や同時進行の上限を増やしません。
