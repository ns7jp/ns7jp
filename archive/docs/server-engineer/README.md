...
SE07以降の道筋は[初心者から熟練への橋渡し設計](./advanced/README.md)へ。複数台、性能・容量、移行、他者の育成・標準改善へ進む12の発展課題を用意しています。BRは能力の見取り図で、既存のSE合否や職場の権限を置き換えません。
...
旧[24週教材](../../../docs/learning-plan/02-curriculum.md)は週15時間を想定しています。本育成体系と[橋渡し計画](./advanced/action-plan.md)は週10時間を基準とし、旧教材を条件ごとの学習・補習素材として選びます。同じ24週で同じ工数を消化する計画ではありません。
...
- **学ぶ内容と実施キット**: [24週の学習プラン](../../../docs/learning-plan/README.md)、[主作品server](https://github.com/ns7jp/server)。
