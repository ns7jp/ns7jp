...
| やりたいこと | 実施入口 |
| --- | --- |
| Windowsから学習用VMを準備 | [学習環境](../../../docs/learning-plan/01-environment.md)、[Phase 1キット](../../../docs/learning-plan/phase1-kit/README.md) |
| Linuxの最初の確認 | [開始前30分](../../../docs/learning-plan/00-start-here.md) |
...
| 要件から試験票を作る | [構築工程](../../../docs/learning-plan/03-build-process.md)、[server案件パック](https://github.com/ns7jp/server/tree/main/docs/build-package) |
...
| Windows Server／ADを追加する | [Windows基礎](../../../docs/learning-plan/12-windows-server-exercise-design.md)、[ADキット](../../../docs/learning-plan/ad-exercise-kit/README.md) |
| 恒久ホストやクラウドを追加する | [恒久ホスト設計](../../../docs/learning-plan/13-persistent-host-exercise-design.md)、[AWS設計](../../../docs/learning-plan/11-aws-foundational-exercise-design.md) |
