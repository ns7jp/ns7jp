...
文書更新: 2026-09-17。就業状況の最終確認日は 2026-09-11 です。9 月 15 日の終了予定を、終了済みの事実へ読み替えていません。
...
**就業状況（最終確認: 2026-09-11）**: 同日時点では、人材派遣会社（アデコ株式会社）を通じて IT 企業でトライアル就業中（2026/07〜）で、終了予定日は 2026-09-15 でした。**9 月 17 日現在の終了・継続状況と入社可能日は本人確認待ち**です。就業先の社名は面談時に開示し、入社可能日は個別に相談します。
...
### アデコ株式会社（人材派遣） — 2026-09-11 までの確認情報

| 項目 | 内容 |
| --- | --- |
| 在籍期間 | 2026/07〜（2026-09-11 時点でトライアル就業中。9 月 15 日は当時の終了予定であり、現在の終了・継続は未確認） |
...
| 2026/07〜（終了月未確認） | 人材派遣によるトライアル就業（2026-09-11 までの確認情報。上記参照） |
...
| 普通自動車運転免許 | なし |
| 現在の就業との関係 | 9 月 15 日は 2026-09-11 時点の終了予定。終了・継続は本人確認待ち。正社員としてのインフラ職を志望。経緯は[志望の経緯](./career-bridge.md#志望の経緯)を参照 |
