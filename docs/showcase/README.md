...
「デプロイ → わざと壊す → アラート発火 → 復旧」を 2〜3 分で見せる短尺デモを最優先で収録します。台本は [デモ動画台本](../demo-script.md) に整備済みです。

| 区分 | 内容 | 状態 |
| --- | --- | --- |
| 動画 | 2〜3 分スクリーンキャスト（壊して直す） | 台本整備済み・収録待ち |

> 収録後、本ページ冒頭と [README](../../README.md) 上部にサムネイル付きで掲載します。未経験者で短尺デモまで用意する例は少なく、差別化の効果が最も高い証跡です。
