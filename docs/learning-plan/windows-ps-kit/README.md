...
PowerShell のコマンドをまだほとんど触ったことがない場合は、先に [Windows コマンド集（初心者向け）](../../windows-commands-guide.md)の「6. PowerShell 入門ブリッジ」でコマンドレットの基本と主要な対応コマンドに慣れておくと、この先の演習が読みやすくなります。
