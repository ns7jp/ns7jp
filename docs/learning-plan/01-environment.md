...
OSを入れて一般ユーザーでログインできたら、[最初の30分：状態を確認して記録する](./00-start-here.md#2-最初の-30-分状態を確認して記録する)へ戻り、設定変更前の状態を確かめます。主作品の実習から来た場合は、[初回実習の前提確認](https://github.com/ns7jp/server/blob/main/docs/beginner-learning-guide.md)へ戻ります。このページの基本操作用VMと、主作品の実習に必要なメモリ・Docker等の条件は別に確認してください。
