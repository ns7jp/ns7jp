...
>
> この設計は Google SRE Book / Workbook などの公開されているパターンを参考に組み立てた
> ものであり、実際の SRE 業務経験に基づくものではない。
...
server-monitor は **個人ラボの監視ダッシュボード**。以下の特性を踏まえる。

| 特性 | 内容 |
| --- | --- |
| 利用者 | 自分（開発・運用を一人で担当） |
| 利用時間帯 | 学習・検証のため不定期にアクセス |
