...
> 記録テンプレートは [server](https://github.com/ns7jp/server) に実装済みである。
> D-1 は[2026-08-19 の RTO 13 秒](https://github.com/ns7jp/server/blob/main/docs/drills/logs/2026-08-19-D-1.md)を
> 履歴として保持している。[PR #75 Full-stack E2E](https://github.com/ns7jp/server/blob/4a292026b569dd1a522c0f2913b4ad40aeccebe7/docs/evidence/2026-08-22-full-stack-e2e.md#pr-75-hardening後の再検証)では、
...
- 一人で実施する場合は観測と操作を兼務する（複数人で実施できる場合は役割分担してもよい）
