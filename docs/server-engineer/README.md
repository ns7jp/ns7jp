...
旧[24週教材](../learning-plan/02-curriculum.md)は週15時間を想定しています。本育成体系と[橋渡し計画](advanced/action-plan.md)は週10時間を基準とし、旧教材を条件ごとの学習・補習素材として選びます。同じ24週で同じ工数を消化する計画ではありません。
