...
| 4 | 結果を [04 SLO](../server-monitor-improvements/04-slo-design.md) [07 IR](07-incident-response.md) と統合レビュー |
| 月次 | ローテーション運用 |
...
- [ ] 月次レビューで Game Day の結果が議題に上がっている（[04 SLO](../server-monitor-improvements/04-slo-design.md) [07 IR](07-incident-response.md) と統合）
