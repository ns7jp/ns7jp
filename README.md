...
製造・物流の現場で「正確性」と「業務改善」を軸にキャリアを積み、ITエンジニア系へキャリアチェンジを目指しています。
...
- フレームワーク（Laravel、Django、React 等）
- クラウド（AWS、GCP）
- Docker / CI/CD
- セキュアなWebアプリケーション設計
...
*現場で培った課題発見・改善力と、新たに習得した技術を掛け合わせ、業務改善・システム品質に貢献するエンジニアとして成長してまいります。*
