...
| 順番 | 見る場所 | 何を判断できるか | 状態 |
| --- | --- | --- | --- |
| 1 | [採用ご担当者さまへ（1 枚）](./docs/overview-for-recruiters.md) | 人柄・現場経験・入社初期に任せやすい業務 | 整備済み |
| 2 | [server-monitor](https://github.com/ns7jp/server-monitor) | Linux / Docker / 監視 / IaC / ランブックの実装力 | コード実装済み |
| 3 | [検証証跡台帳](https://github.com/ns7jp/server-monitor/blob/main/docs/evidence/README.md) / [デモ台本](./docs/demo-script.md) | 実測済み・未測定の境界と「壊して直す」実演準備 | 証跡追加中 |
...
[証跡採録チェックリスト](./docs/evidence-capture-checklist.md) で公開管理しています。
...
- 連絡方法: GitHub プロフィールまたはポートフォリオサイト経由
