...
| # | テーマ | 位置付け | 設計書 |
| --- | --- | --- | --- |
| 06 | 分散トレーシング（Tempo + OTel） | Metrics / Logs の次段階 | [06](./docs/server-monitor-improvements/06-observability-traces.md) |
| 07 | インシデント対応・ポストモーテム | 障害から学ぶ運用プロセス | [07](./docs/server-monitor-improvements/07-incident-response.md) |
| 08 | Kubernetes / EKS 発展計画 | 中長期学習ロードマップ | [08](./docs/server-monitor-improvements/08-kubernetes-roadmap.md) |
| 09 | セキュリティ運用プロセス | 継続的な脆弱性・監査運用 | [09](./docs/server-monitor-improvements/09-security-operations.md) |
| 10 | キャパシティプランニング | SLO と容量判断の定量化 | [10](./docs/server-monitor-improvements/10-capacity-planning.md) |
| 11 | 変更管理プロセス | PR ベースの変更統制 | [11](./docs/server-monitor-improvements/11-change-management.md) |
| 12 | メタモニタリング | 監視基盤そのものの監視 | [12](./docs/server-monitor-improvements/12-meta-monitoring.md) |
| 13 | FinOps | クラウド費用の月次運用 | [13](./docs/server-monitor-improvements/13-finops.md) |
| 14 | データベース運用設計 | バックアップ / PITR / 性能調査 | [14](./docs/server-monitor-improvements/14-database-operations.md) |
| 15 | ネットワーク・DNS 運用 | TLS / SG / SSM / DNS 棚卸し | [15](./docs/server-monitor-improvements/15-network-operations.md) |
| 16 | アイデンティティ運用 | ID ライフサイクル / SSO / PAM | [16](./docs/server-monitor-improvements/16-identity-operations.md) |
| 17 | カオスエンジニアリング / Game Day | 復旧性と検知性の実証 | [17](./docs/server-monitor-improvements/17-chaos-engineering.md) |
